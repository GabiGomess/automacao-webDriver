...
public class EnterInsurantDataPage extends PageBase {
    ...
    // Actions
    public void preencherCampoFirstName (String key) { sendKeys(firstNameField, key); }
    public void preencherCampoLastName (String key) { sendKeys(lastNameField, key); }
    public void preencherCampoDateOfBirth (String key) { sendKeys(dateOfBirthField, key); }
    ...
    public void preencherCampoStreetAddress (String key) { sendKeys(streetAddressField, key); }
    public void preencherCampoCountry (String key) { sendKeys(countryField, key); }
    public void preencherCampoZipCodeField (String key) { sendKeys(zipCodeField, key); }
    public void preencherCampoCityField (String key) { sendKeys(cityField, key); }
    public void preencherCampoOccupationField (String key) { sendKeys(occupationField, key); }
    ...
    public void preencherCampoWebsite (String key) { sendKeys(websiteField, key); }
    public void preencherCampoPicture () throws IOException { driver.findElement(pictureField).sendKeys( new File("../automacao-webDriver-Accenture/example.txt").getCanonicalPath()); }
