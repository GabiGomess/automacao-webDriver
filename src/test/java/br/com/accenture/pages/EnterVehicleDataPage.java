...
public class EnterVehicleDataPage extends PageBase {
    ...
    // Actions
    public void preencherCampoMake(String key) {
        sendKeys(makeField, key);
    }

    public void preencherCampoModel(String key) {
        sendKeys(modelField, key);
    }

    public void preencherCampoCylinderCapacity(String key) {
        sendKeys(cylinderCapacityField, key);
    }

    public void preencherCampoEnginePerformance(String key) {
        sendKeys(enginePerformanceField, key);
    }

    public void preencherCampoDateOfManufacture(String key) {
        sendKeys(dateOfManufactureField, key);
    }

    public void preencherCampoNumberOfSeats(String key) {
        sendKeys(numberOfSeatsField, key);
    }

    public void preencherCampoRightHandDrive(String key) {
        if (key.equalsIgnoreCase("Yes")) {
            radioBox(rightHandDriveYesField, key);
        } else {
            radioBox(rightHandDriveNoField, key);
        }
    }

    public void preencherCampoNumberOfSeatsMotorcycle(String key) {
        sendKeys(numberOfSeatsMotorcycleField, key);
    }

    public void preencherCampofuelType(String key) {
        sendKeys(fuelTypeField, key);
    }

    public void preencherCampoPayload(String key) {
        sendKeys(payloadField, key);
    }

    public void preencherCampoTotalWeight(String key) {
        sendKeys(totalWeightField, key);
    }

    public void preencherCampoListPrice(String key) {
        sendKeys(listPriceField, key);
    }

    public void preencherCampoLicensePlateNumber(String key) {
        sendKeys(licensePlateNumberField, key);
    }

    public void preencherCampoAnnualMileage(String key) {
        sendKeys(annualMileageField, key);
    }
