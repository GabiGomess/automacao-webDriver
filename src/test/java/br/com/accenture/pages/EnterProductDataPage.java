...
public class EnterProductDataPage extends PageBase {
    ...
    // Actions
    public void preencherCampoStartDate(String key) {
        sendKeys(startDateField, key);
    }

    public void preencherCampoInsuranceSum(String key) {
        sendKeys(insuranceSumField, key);
    }

    public void preencherCampoMeritRating(String key) {
        sendKeys(meritRatingField, key);
    }

    public void preencherCampoDamageInsurance(String key) {
        sendKeys(damageInsuranceField, key);
    }
    ...
    public void preencherCampoCourtesyCar(String key) {
        String firstLtr = key.substring(0, 1);
        String restLtrs = key.substring(1);
        firstLtr = firstLtr.toUpperCase();
        key = firstLtr + restLtrs;
        sendKeys(courtesyCarField, key);
    }
