...
import static br.com.accenture.utils.Constants.countryValues;
import static br.com.accenture.utils.Constants.occupationValues;
...
public class PreencherFormularioEnterInsurantDataStepDefinitions {
    ...
    public void inserirCampoFirstNameComValorDefinido(@NotNull String valor) {
        assertNotNull(valor);
        enterInsurant.preencherCampoFirstName(valor);
    }

    @And("^inserir campo <Last Name> com valor '(.*)'$")
    public void inserirCampoLastNameComValorDefinido(@NotNull String valor) {
        assertNotNull(valor);
    ...
    public void inserirCampoDateOfBirthComValorDefinido(String mm, String dd, String yyyy) throws ParseException {
        ...
        assertTrue(generator.maioridadeValidador(data));
        enterInsurant.preencherCampoDateOfBirth(data);
    }

    @And("^selecionar campo <Gender> com valor '(.*)'$")
    public void selecionarCampoGenderComValorDefinido(@Nullable String valor) {
    ...
    public void inserirCampoStreetAddressComValorDefinido(@Nullable String valor) {
        enterInsurant.preencherCampoStreetAddress(valor);
    }

    @And("^selecionar campo <Country> com valor '(.*)'$")
    public void selecionarCampoCountryComValorDefinido(@NotNull String valor) {
        assertNotNull(valor);
    ...
    public void inserirCampoZipCodeComValorDefinido(@NotNull int valor) {
    ...
    public void inserirCampoCityComValorDefinido(String valor) {
        if (valor.isEmpty()) { enterInsurant.preencherCampoCityField(null); }
        else { enterInsurant.preencherCampoCityField(valor); }
    }

    @And("^selecionar campo <Occupation> com valor '(.*)'$")
    public void selecionarCampoOccupationComValorDefinido(@NotNull String valor) {
        assertNotNull(valor);
    ...
    public void selecionarCampoHobbiesComValorDefinido(String valor) {
        String[] hobbies = valor.toLowerCase().replace(" ", "").split(",");
    ...
    @After
    public void afterScenario() { enterInsurant.tearDown(); }
}
